...
import { View, Text, ScrollView, TextInput, Pressable, TouchableOpacity, Linking, ImageBackground } from 'react-native';
...
const Register = () => {
    ...
    return (
        <LinearGradient
            ...
            <View style={RegisterStyle.Setregisterheight}>
                <ScrollView
                    ...
                    <View style={RegisterStyle.container}>
                        <View style={Style.minviewallcontent}>
                            <View style={RegisterStyle.settopspaceregister}>
                                <Text style={RegisterStyle.setregistertext}>{Strings.register.register}</Text>
                            </View>
                            ...
                            <View style={RegisterStyle.settopspace}>
                                <View style={RegisterStyle.AlredyandloginBox}>
                                    <Text style={RegisterStyle.membertextstyle}>Already a member?</Text>
                                    <TouchableOpacity onPress={() => navigation.navigate(RouteName.LOGIN_SCREEN)}>
                                        <Text style={RegisterStyle.LoginScreenText}>{Strings.login.login}</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
